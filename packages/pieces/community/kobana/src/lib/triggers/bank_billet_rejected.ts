...
const event_code = 'bank_billet.rejected';

export const bank_billet_rejected = createTrigger({
  auth: kobanaAuth,
  name: 'bank_billet_rejected',
  displayName: `Boleto Rejeitado (${event_code})`,
  description: 'Toda vez que um boleto é rejeitado.',
  props: {},
  sampleData: {
    bankBilletFactory,
  },

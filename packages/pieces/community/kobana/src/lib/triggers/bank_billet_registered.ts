...
const event_code = 'bank_billet.registered';

export const bank_billet_registered = createTrigger({
  auth: kobanaAuth,
  name: 'bank_billet_registered',
  displayName: `Boleto Registrado (${event_code})`,
  description: 'Toda vez que um boleto é registrado.',
  props: {},
  sampleData: {
    bankBilletFactory,
  },

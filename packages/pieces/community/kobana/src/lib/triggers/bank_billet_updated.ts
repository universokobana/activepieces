...
const event_code = 'bank_billet.updated';

export const bank_billet_updated = createTrigger({
  auth: kobanaAuth,
  name: 'bank_billet_updated',
  displayName: `Boleto Atualizado (${event_code})`,
  description: 'Toda vez que um boleto é atualizado.',
  props: {},
  sampleData: {
    bankBilletFactory,
  },
